  ...
  const htmlUsuario = isContador ? `
    ...
    <div style="font-family:Arial,sans-serif;max-width:560px;margin:0 auto;color:#111318">
      ...
      <div style="background:#fff;padding:36px;border:1px solid #e8e4dc;border-top:none;border-radius:0 0 12px 12px">
        ...
        <div style="background:#fef3e2;border-left:4px solid #b8860b;padding:16px 20px;border-radius:0 8px 8px 0;margin:0 0 20px"> <p style="margin:0;font-weight:600;color:#9a5c00">📅 Prazo mais crítico: Setembro de 2026</p>
        ...
        <p style="font-weight:600;margin:0 0 12px">Nos próximos dias você vai receber:</p>
